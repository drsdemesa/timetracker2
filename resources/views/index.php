                   ...
                   <div class="row">
                    ...
                    <div class="row edit-time-entry" ng-show="showEditDialog === true">
                        ...
                        <div class="time-entry">
                            <div class="timepicker">
                                <span class="timepicker-title label label-primary">Clock In</span>
                                <div uib-timepicker ng-model="time.start_time" hour-step="1" minute-step="1" show-meridian="true"></div>
                            </div>
                            <div class="timepicker">
                                <span class="timepicker-title label label-primary">Clock Out</span>
                                <div uib-timepicker ng-model="time.end_time" hour-step="1" minute-step="1" show-meridian="true"></div>
                            </div>
                       </div>
                       <div class="col-sm-6">
                            <h5>User</h5>
